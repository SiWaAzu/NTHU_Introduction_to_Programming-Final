...
void draw_end3_scene(ALLEGRO_BITMAP* END3_pic,const int SCREEN_H,const int SCREEN_W,ALLEGRO_FONT* font_pirulen_16)
{
	al_draw_bitmap(END3_pic, 0, 0, 0);
...
void END3_click_but(int btn, int x, int y,int mouse_x,int mouse_y)
{
	if (btn == 1)
		{
			change_flag (4);
