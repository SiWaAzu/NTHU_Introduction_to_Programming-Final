...
void draw_end1_scene(ALLEGRO_BITMAP* END1_pic,const int SCREEN_H,const int SCREEN_W,ALLEGRO_FONT* font_pirulen_16)
{
	al_draw_bitmap(END1_pic, 0, 0, 0);
...
void END1_click_but(int btn, int x, int y,int mouse_x,int mouse_y)
{
	if (btn == 1)
		{
			change_flag (4);
